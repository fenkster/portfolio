...
```
***
The first thing to point out is that **Loungin** is a lot shorter. Both songs seem to contain stronger magnitude in the keys of C, C#/D flat as well as A and B.
...
I already looked at Southern Rap in the mean analysis. Now, as a fun exercise, I will use my random forest model trained on the other 4 playlists of my corpus to classify the songs from the South playlist. But before that, let's look at the most important features in the context of the South.
...
### The moment of truth! *Predicting the South*
...
### Bonus *Individual track predictions*
